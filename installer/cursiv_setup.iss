; ============================================================
; Cursiv v3.14-U02 — Live Routing & Account Recovery
; Produces: installer\Output\Cursiv-Setup-3.14-U02.exe
;
...
OutputDir=Output
OutputBaseFilename=Cursiv-Setup-3.14-U02
