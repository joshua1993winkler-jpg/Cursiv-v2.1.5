...
:: Compiles installer\cursiv_setup.iss into Cursiv-Setup-3.14-U01.exe
...
:: ── Verify output ────────────────────────────────────────────
if not exist "installer\Output\Cursiv-Setup-3.14-U01.exe" (
    echo [ERROR] Installer not found at installer\Output\Cursiv-Setup-3.14-U01.exe
    pause & exit /b 1
)
...
echo  │  File: installer\Output\Cursiv-Setup-3.14-U01.exe         │
echo  └──────────────────────────────────────────────────────┘
echo.
pause
